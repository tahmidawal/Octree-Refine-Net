...
def main():
    ...
    print(f"  - Alternating Topologies: (5,6) and (6,7)")
        ...
        if step % 100 == 0 or step == num_steps - 1:
            ...
            if n_samples > 0:
                ...
                for row, sample in enumerate(sample_trees):
                    ...
                    ax2.set_title(f"Predicted Step {sample['step']}", fontsize=10)
                    ...
                    ax3.set_title(f"Per-Leaf Loss (MSE)", fontsize=10)
                    ...
                    if depths:
                        ...
                        ax4.set_title(f"Avg Loss by Depth", fontsize=10)
